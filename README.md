...
* Built a **LangChain + LLaMA-powered LinkedIn automation tool**, cutting post drafting time by **80%**.
* Integrated **AI-driven engagement analytics** to improve post visibility.

**🔹 Data Science Intern – Jaipur Smart City Limited** *(April 2025 – June 2025)*

* Deployed **YOLOv5 + OpenCV traffic detection** across 15+ intersections, boosting accuracy by **25%**.
* Reduced manual monitoring workload by **40%**.
...
✨ *Building AI solutions, exploring data, and solving problems — one commit at a time!* ✨
